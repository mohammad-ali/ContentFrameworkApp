...
public class NiceSpinner extends TextViewPlus {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if(!Settings_Activity.loadNightMode(context)){
            ...
            setBackgroundResource(R.drawable.blackbox);
        }



        if(!Settings_Activity.loadNightMode(context)){
            textColor = context.getResources().getColor(R.color.text_dark);
        }else{
            textColor = context.getResources().getColor(R.color.text_light);
        }
        setTypeface(App.sans);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if(!Settings_Activity.loadNightMode(context)){
                popupWindow.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.spinnerback));
            }else{
                popupWindow.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.blackbox));
            }
